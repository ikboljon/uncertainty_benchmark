...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1):
        ...
        # self.dropout2 = nn.Dropout(p=0.5)  # Add dropout layer
...
class ResNet(nn.Module):
    ...
    def eval(self):
        # Override the default eval() method
        self.train()


def ResNet18_MCD(in_channels, num_classes):
    return ResNet(BasicBlock, [2, 2, 2, 2], in_channels=in_channels, num_classes=num_classes)


def ResNet50_MCD(in_channels, num_classes):
